...
export function DemoBanner({ offline, onSwitchLive }: { offline: boolean; onSwitchLive?: () => void }) {
  ...
  return (
    <div className="mb-6 flex flex-wrap items-center justify-between gap-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 dark:border-amber-800/50 dark:bg-amber-950/30">
      <p className="text-sm text-amber-900 dark:text-amber-200">
        <span className="font-semibold">Offline demo mode</span> — showing embedded sample data. Connect the backend for live analysis.
      </p>
      {onSwitchLive && (
